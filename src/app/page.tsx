      ...
      <footer className="relative pt-4 md:pt-8 pb-10 md:pb-16 px-6 overflow-hidden">
        ...
        <div className="relative text-center max-w-lg mx-auto flex flex-col items-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-[#8b3a3a]/50 text-[#c47a7a] hover:text-white hover:border-[#c47a7a] hover:bg-[#8b3a3a]/15 transition-all duration-500 group mb-6"
          >
